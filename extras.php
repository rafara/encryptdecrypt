...
function NexoDeriveKeymaterial($passphrase) {
  ...
  echo '<br/>========keys:=====<br/>';
  echo '<br/>hmac = '.bin2hex($hmac_key);
echo '<br/>cipher_key = '.bin2hex($cipher_key);
echo '<br/>iv = '.bin2hex($iv);
...
function NexoReceiver($message,$keymaterial) {
  ...
  //   return 'different computed HMAC';
  // }
